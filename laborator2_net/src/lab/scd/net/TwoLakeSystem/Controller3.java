package lab.scd.net.TwoLakeSystem;

import lab.scd.net.Components.*;
import lab.scd.net.DataObjects.DataFloat;
import lab.scd.net.DataObjects.DataString;
import lab.scd.net.DataObjects.DataTransfer;
import lab.scd.net.DataOnly.TransferOperation;
import lab.scd.net.Enumerations.LogicConnector;
import lab.scd.net.Enumerations.TransitionCondition;
import lab.scd.net.Enumerations.TransitionOperation;
